use branch_and_bound::{SearchProblem, SearchState, OptimizationGoal, solvers::BfsSolver, ResultNode};
use bitvec::prelude::*;
...
fn main() {
    ...
    let matrix = BitMatrix::load_from_file("../kingfisher_rust/test_data.txt", 4).unwrap();
